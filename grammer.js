...
var grammar = {
    ...
    {"name": "statements", "symbols": ["statement", (lexer.has("nl") ? {type: "nl"} : nl), "statements"], "postprocess": 
        (data) => [data[0], ...data[2]]
          },
    {"name": "statement", "symbols": ["assignment"], "postprocess": id},
    {"name": "statement", "symbols": ["function_call"], "postprocess": id},
    {"name": "assignment", "symbols": [(lexer.has("identifier") ? {type: "identifier"} : identifier), "_", {"literal":"="}, "_", "literal"], "postprocess": 
        (data) => {
          return {
            type: "assignment",
            var_name: data[0],
